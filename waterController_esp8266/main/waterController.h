...
const char string_0[]  = "String 0"; // "String 0" etc are strings to store - change to suit.
#define UNREC_PARAM_ERR_STR 1
const char string_1[]  = "ERROR - Unrecognised Parameter ";
#define SETTING_STR 2
const char string_2[]  = "Setting ";
#define CYCLE_SECS_ERR_STR 3
const char string_3[]  = "ERROR - CYCLE_SECS must be greater than ON_SECS";
const char string_4[]  = "Setting ON_SECS=";
#define ON_SECS_ERR_STR 5
const char string_5[]  = "ERROR ON_SECS must be less than CYCLE_SECS";
#define ON_SECS_STR 6
const char string_6[]  = "ON_SECS";
#define CYCLE_SECS_STR 7
const char string_7[]  = "CYCLE_SECS";


const char *const string_table[]  = {string_0, string_1, string_2, string_3, string_4, string_5, string_6, string_7};
